<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Page1.aspx.cs" Inherits="TechnicalHomework4.Page1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <h2>Welcome to Page 1</h2>
    <h3>This is the content for my Page 1.</h3>
